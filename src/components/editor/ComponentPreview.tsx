                  ...
                  <CodeBlockBody>
                    {(item) => (
                      <CodeBlockItem
                        ...
                        value={item.language}
                        lineNumbers
                    className="overflow-y-auto overflow-x-auto max-h-[calc(100vh-300px)] [&_.shiki]:bg-card [&_code]:whitespace-pre! [&_code]:overflow-x-auto! [&_code]:block! [&_code]:grid-none! [&_.line]:whitespace-pre! [&_pre]:m-0! [&_pre]:py-0! [&_pre]:px-0!"
                      >
                        <CodeBlockContent 
                          language="tsx"
                          themes={{
